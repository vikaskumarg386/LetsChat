...
public class friendsF extends Fragment {
    ...
    public void showFriends() {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<users, friendsViewHolder>(options) {
            ...
            @Override
            protected void onBindViewHolder(@NonNull final friendsViewHolder viewHolder, int position, @NonNull users model) {
                                ...
                                builder.setItems(items, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if(which==0){
                                            ...
                                            profileIntent.putExtra("key_noti",list_userId);
                                        ...
                                        if(which==1){
                                            ...
                                            chatIntent.putExtra("key_noti",list_userId);
                ...
                mRootRef.child("deactivateAccount").addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.hasChild(list_userId)){
                            viewHolder.setImage("abc",getContext());
                            viewHolder.setDate("Deactivated Account");
                            viewHolder.setOnlineStatus("false");
                            viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    Toast.makeText(getContext(),"Deactivated Account",Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
    ...
    public static class friendsViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setName(String name){
            TextView nameText=(TextView)mView.findViewById(R.id.notification);
            nameText.setText(name);
        }

        public void setImage(String img,Context context){

            CircleImageView imgView=(CircleImageView)mView.findViewById(R.id.notiImage);
